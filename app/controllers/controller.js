...
app.controller('navCtrl', function($scope,$rootScope, $location,$modal,$http,$timeout,jwtHelper,loadData){
	...
	$scope.today = new Date();
       ...
       $scope.navibar = true;
       $rootScope.userid=uinfo[0].user_id;
    ...
    if($rootScope.userid != undefined){
      ...
      checknoti(userid);
      function checknoti(userid){
        loadData(serviceurl,'getnotidata',userid).success(function(data){
          $scope.notidata=data;    
          // console.log(data);
        });
      }
